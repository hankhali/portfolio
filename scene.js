...
const THEMES = {
  // Palette tones. The dark ground is a darkened deep-space-blue, which keeps
  // enough depth for the additive pass to read.
  dark:  { a: '#c6878f', b: '#b79d94', c: '#e9dfda', dust: '#b79d94',
           base: 0.7, glow: 2.2, bright: 1.8, blend: THREE.AdditiveBlending },
  light: { a: '#5c5e70', b: '#253d5b', c: '#8d4f58', dust: '#67697c',
